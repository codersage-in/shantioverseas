	...
	$.fn.rt_mediaelementplayer = function() {		
		...
		media_holders.mediaelementplayer({
			success: function(mediaElement, originalNode){
				...
				// console.log(media_holders);

				// media_holders.each(function(){
				// 	var controls = media_holders.find("mejs-controls");
				// 	var rail = media_holders.find("mejs-time-rail");
				// 	var controls_width = 0;

				// 	console.log(controls);


				// 	controls.find(">*").each(function(){
				// 			console.log("-");
				// 		console.log($(this));

				// 		controls_width = controls_width + $(this).outerWidth();
				// 	});
